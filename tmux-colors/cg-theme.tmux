...
tm_session="#[fg=$tm_light_green,bg=$tm_bg_highlight,bold] $tm_network_status "
...
tm_right_section="#[fg=$tm_light_green,bg=$tm_bg_highlight] $tm_datetime $tm_battery_status "
...
tm_win_active="#[fg=$tm_light_green,bg=$tm_bg_highlight] $tm_win_name "
