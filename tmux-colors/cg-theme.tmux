...
tm_right_section="#[fg=$tm_fg,bg=$tm_bg,bold]$tm_datetime #[fg=$tm_black,bg=$tm_fg,bold] $tm_battery_status $tm_network_status "
...
tm_win_active="#[fg=$tm_fg,bg=$tm_bg,bold]  #W #[fg=$tm_green,bg=$tm_bg,bold] "
