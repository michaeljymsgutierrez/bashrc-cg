...
display_right_section_content="#[fg=$pane_text_color,bg=$pane_background_color] $display_datetime $display_battery_status 󰎟  $display_mail_notification_count $display_calendar_notification_count $display_slack_notification_count $display_discord_notification_count $display_system_notification_count"
